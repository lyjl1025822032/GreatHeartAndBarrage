...
- (void)viewDidLoad {
    ...
    drawMarqueeView0.speed         = [self randomValue];
    drawMarqueeView1.speed         = [self randomValue];
    drawMarqueeView2.speed         = [self randomValue];
    drawMarqueeView3.speed         = [self randomValue];
    ...
    // text
    [drawMarqueeView0 addContentView:[self createLabelWithText:@"夏天是个很好的季节, 而夏天然后是简书的推荐作者, 喜欢分享!" textColor:[self randomColor]]];
    [drawMarqueeView1 addContentView:[self createLabelWithText:@"夏天然后是简书的推荐作者" textColor:[self randomColor]]];
    [drawMarqueeView2 addContentView:[self createLabelWithText:@"夏天是个iOS开发者" textColor:[self randomColor]]];
    [drawMarqueeView3 addContentView:[self createLabelWithText:@"喜欢分享!" textColor:[self randomColor]]];
